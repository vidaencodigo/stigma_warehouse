        ...
        <div class="container_app">
            ...
            <section class="content-app">
                <div class="search--product--content">
                    <form method="post" action="index.php?controller=entradas&action=get_product">
                ...
                <div class="producto--form">
                    <div class="card--form">
                        ...
                        <?php if (isset($product)) : ?>
                            <form method="POST" action="index.php?controller=entradas&action=save_entrie">
                                <div class="group--form">
                                    <img src="data:image/png;base64,<?= base64_encode($product->product_image) ?>" alt="<?= $product->name; ?>" class="image--table">
                                </div>
                                ...
                                <div class="group--form">
                                    ...
                                    <input type="number" step="any" name="ticket" id="ticket" class="control" value="0" autofocus selected required>
                                </div>
                                ...
                                <div class="group--form">
                                    ...
                                    <input type="number" step="any" name="quantity" id="quantity" class="control" value="0" required>
                                </div>
